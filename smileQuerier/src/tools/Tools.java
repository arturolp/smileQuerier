...
public class Tools {
	...
	public static void print(ArrayList<Double[]> obj) throws Exception {
		for (int i = 0; i < obj.size(); i++) {
			for (int j = 0; j < obj.get(i).length - 1; j++) {
				System.out.print(obj.get(i)[j] + ", ");
				System.out.flush();
			}
			System.out.println(obj.get(i)[obj.get(i).length - 1]);
		}
	}
